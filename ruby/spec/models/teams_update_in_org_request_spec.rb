...
# Unit tests for OpenapiClient::TeamsUpdateInOrgRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamsUpdateInOrgRequest do
  let(:instance) { OpenapiClient::TeamsUpdateInOrgRequest.new }

  describe 'test an instance of TeamsUpdateInOrgRequest' do
    it 'should create an instance of TeamsUpdateInOrgRequest' do
      expect(instance).to be_instance_of(OpenapiClient::TeamsUpdateInOrgRequest)
    end
  end
