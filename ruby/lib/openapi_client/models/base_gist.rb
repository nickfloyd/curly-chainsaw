...
module OpenapiClient
  ...
  class BaseGist
    ...
    attr_accessor :git_pull_url

    attr_accessor :git_push_url
    ...
    def self.openapi_types
      {
        ...
        :'git_push_url' => :'String',
        :'html_url' => :'String',
        :'files' => :'Hash<String, BaseGistFilesValue>',
        :'public' => :'Boolean',
        :'created_at' => :'Time',
        :'updated_at' => :'Time',
        :'description' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::BaseGist` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::BaseGist`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'git_pull_url')
        self.git_pull_url = attributes[:'git_pull_url']
      end

      if attributes.key?(:'git_push_url')
        self.git_push_url = attributes[:'git_push_url']
      end
      ...
      if attributes.key?(:'files')
        if (value = attributes[:'files']).is_a?(Hash)
          self.files = value
        end
      end
      ...
      if attributes.key?(:'forks')
        if (value = attributes[:'forks']).is_a?(Array)
          self.forks = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @git_pull_url.nil?
        invalid_properties.push('invalid value for "git_pull_url", git_pull_url cannot be nil.')
      end

      if @git_push_url.nil?
        invalid_properties.push('invalid value for "git_push_url", git_push_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @git_pull_url.nil?
      return false if @git_push_url.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          node_id == o.node_id &&
          git_pull_url == o.git_pull_url &&
          git_push_url == o.git_push_url &&
          html_url == o.html_url &&
          files == o.files &&
          public == o.public &&
    ...
    def hash
      [url, forks_url, commits_url, id, node_id, git_pull_url, git_push_url, html_url, files, public, created_at, updated_at, description, comments, user, comments_url, owner, truncated, forks, history].hash
    end
