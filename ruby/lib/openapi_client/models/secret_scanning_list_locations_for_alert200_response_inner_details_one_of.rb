...
module OpenapiClient
  ...
  class SecretScanningListLocationsForAlert200ResponseInnerDetailsOneOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SecretScanningListLocationsForAlert200ResponseInnerDetailsOneOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SecretScanningListLocationsForAlert200ResponseInnerDetailsOneOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'blob_sha')
        self.blob_sha = attributes[:'blob_sha']
      end
    ...
    def list_invalid_properties
      ...
      if @blob_sha.nil?
        invalid_properties.push('invalid value for "blob_sha", blob_sha cannot be nil.')
      end
      ...
      if @commit_url.nil?
        invalid_properties.push('invalid value for "commit_url", commit_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @blob_sha.nil?
      return false if @blob_url.nil?
      return false if @commit_sha.nil?
      return false if @commit_url.nil?
      true
    end
    ...
    def hash
      [path, start_line, end_line, start_column, end_column, blob_sha, blob_url, commit_sha, commit_url].hash
    end
