  ...
  class Snapshot
    ...
    def self.openapi_types
      {
        ...
        :'manifests' => :'Hash<String, SnapshotManifestsValue>',
        :'scanned' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'manifests')
        if (value = attributes[:'manifests']).is_a?(Hash)
    ...
    def valid?
      ...
      return false if @ref !~ Regexp.new(/^refs\//)
    ...
    def hash
      [version, job, sha, ref, detector, metadata, manifests, scanned].hash
    end
