...
module OpenapiClient
  ...
  class Tag
    ...
    def list_invalid_properties
      ...
      if @zipball_url.nil?
        invalid_properties.push('invalid value for "zipball_url", zipball_url cannot be nil.')
      end

      if @tarball_url.nil?
        invalid_properties.push('invalid value for "tarball_url", tarball_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @zipball_url.nil?
      return false if @tarball_url.nil?
    ...
    def hash
      [name, commit, zipball_url, tarball_url, node_id].hash
    end
