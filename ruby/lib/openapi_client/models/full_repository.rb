...
module OpenapiClient
  ...
  class FullRepository
    ...
    attr_accessor :template_repository
    ...
    attr_accessor :anonymous_access_enabled
    ...
    def self.openapi_types
      {
        ...
        :'template_repository' => :'Repository1',
        ...
        :'security_and_analysis' => :'FullRepositorySecurityAndAnalysis'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::FullRepository` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::FullRepository`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'template_repository')
        self.template_repository = attributes[:'template_repository']
      end
      ...
      if attributes.key?(:'anonymous_access_enabled')
        self.anonymous_access_enabled = attributes[:'anonymous_access_enabled']
      else
        self.anonymous_access_enabled = true
      end
    ...
    def list_invalid_properties
      ...
      if @subscribers_count.nil?
        invalid_properties.push('invalid value for "subscribers_count", subscribers_count cannot be nil.')
      end

      if @network_count.nil?
        invalid_properties.push('invalid value for "network_count", network_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subscribers_count.nil?
      return false if @network_count.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          template_repository == o.template_repository &&
          ...
          watchers == o.watchers &&
          anonymous_access_enabled == o.anonymous_access_enabled &&
