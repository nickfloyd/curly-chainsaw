  ...
  class GPGKey
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GPGKey` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GPGKey`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @subkeys.nil?
        invalid_properties.push('invalid value for "subkeys", subkeys cannot be nil.')
      end

      if @can_sign.nil?
        invalid_properties.push('invalid value for "can_sign", can_sign cannot be nil.')
      end

      if @can_encrypt_comms.nil?
        invalid_properties.push('invalid value for "can_encrypt_comms", can_encrypt_comms cannot be nil.')
      end

      if @can_encrypt_storage.nil?
        invalid_properties.push('invalid value for "can_encrypt_storage", can_encrypt_storage cannot be nil.')
      end

      if @can_certify.nil?
        invalid_properties.push('invalid value for "can_certify", can_certify cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subkeys.nil?
      return false if @can_sign.nil?
      return false if @can_encrypt_comms.nil?
      return false if @can_encrypt_storage.nil?
      return false if @can_certify.nil?
    ...
    def hash
      [id, name, primary_key_id, key_id, public_key, emails, subkeys, can_sign, can_encrypt_comms, can_encrypt_storage, can_certify, created_at, expires_at, revoked, raw_key].hash
    end
