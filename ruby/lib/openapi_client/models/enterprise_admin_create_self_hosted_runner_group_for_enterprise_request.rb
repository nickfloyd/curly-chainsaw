...
module OpenapiClient
  class EnterpriseAdminCreateSelfHostedRunnerGroupForEnterpriseRequest
    ...
    attr_accessor :selected_organization_ids
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EnterpriseAdminCreateSelfHostedRunnerGroupForEnterpriseRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EnterpriseAdminCreateSelfHostedRunnerGroupForEnterpriseRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'selected_organization_ids')
        if (value = attributes[:'selected_organization_ids']).is_a?(Array)
          self.selected_organization_ids = value
        end
      end

      if attributes.key?(:'runners')
    ...
    def valid?
      ...
      visibility_validator = EnumAttributeValidator.new('String', ["selected", "all"])
    ...
    def visibility=(visibility)
      validator = EnumAttributeValidator.new('String', ["selected", "all"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          selected_organization_ids == o.selected_organization_ids &&
          runners == o.runners &&
    ...
    def hash
      [name, visibility, selected_organization_ids, runners, allows_public_repositories, restricted_to_workflows, selected_workflows].hash
    end
