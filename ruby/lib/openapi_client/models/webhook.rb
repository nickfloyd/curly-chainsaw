...
module OpenapiClient
  ...
  class Webhook
    ...
    def list_invalid_properties
      ...
      if @test_url.nil?
        invalid_properties.push('invalid value for "test_url", test_url cannot be nil.')
      end
      ...
      if @last_response.nil?
        invalid_properties.push('invalid value for "last_response", last_response cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @test_url.nil?
      return false if @ping_url.nil?
      return false if @last_response.nil?
      true
    end
    ...
    def hash
      [type, id, name, active, events, config, updated_at, created_at, url, test_url, ping_url, deliveries_url, last_response].hash
    end
