  ...
  class DependencyGraphDiffInner
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DependencyGraphDiffInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DependencyGraphDiffInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'source_repository_url')
        self.source_repository_url = attributes[:'source_repository_url']
      end
    ...
    def list_invalid_properties
      ...
      if @ecosystem.nil?
        invalid_properties.push('invalid value for "ecosystem", ecosystem cannot be nil.')
      end
    ...
    def valid?
      ...
      change_type_validator = EnumAttributeValidator.new('String', ["added", "removed"])
      return false unless change_type_validator.valid?(@change_type)
      return false if @manifest.nil?
      return false if @ecosystem.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          license == o.license &&
          source_repository_url == o.source_repository_url &&
    ...
    def hash
      [change_type, manifest, ecosystem, name, version, package_url, license, source_repository_url, vulnerabilities].hash
    end
