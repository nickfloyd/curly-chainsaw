...
module OpenapiClient
  ...
  class PrivateUser
    ...
    attr_accessor :two_factor_authentication

    attr_accessor :plan

    attr_accessor :suspended_at

    attr_accessor :business_plus
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PrivateUser` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PrivateUser`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'two_factor_authentication')
        self.two_factor_authentication = attributes[:'two_factor_authentication']
      end
      ...
      if attributes.key?(:'business_plus')
        self.business_plus = attributes[:'business_plus']
      end
    ...
    def list_invalid_properties
      ...
      if @private_gists.nil?
        invalid_properties.push('invalid value for "private_gists", private_gists cannot be nil.')
      end

      if @total_private_repos.nil?
        invalid_properties.push('invalid value for "total_private_repos", total_private_repos cannot be nil.')
      end

      if @owned_private_repos.nil?
        invalid_properties.push('invalid value for "owned_private_repos", owned_private_repos cannot be nil.')
      end

      if @disk_usage.nil?
        invalid_properties.push('invalid value for "disk_usage", disk_usage cannot be nil.')
      end
      ...
      if @two_factor_authentication.nil?
        invalid_properties.push('invalid value for "two_factor_authentication", two_factor_authentication cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @private_gists.nil?
      return false if @total_private_repos.nil?
      return false if @owned_private_repos.nil?
      return false if @disk_usage.nil?
      return false if @collaborators.nil?
      return false if @two_factor_authentication.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          two_factor_authentication == o.two_factor_authentication &&
          plan == o.plan &&
          suspended_at == o.suspended_at &&
          business_plus == o.business_plus &&
          ldap_dn == o.ldap_dn
    end
