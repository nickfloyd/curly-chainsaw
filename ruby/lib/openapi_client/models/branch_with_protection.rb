  ...
  class BranchWithProtection
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::BranchWithProtection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::BranchWithProtection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @protection.nil?
        invalid_properties.push('invalid value for "protection", protection cannot be nil.')
      end

      if @protection_url.nil?
        invalid_properties.push('invalid value for "protection_url", protection_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @protection_url.nil?
      true
    end
    ...
    def hash
      [name, commit, _links, protected, protection, protection_url, pattern, required_approving_review_count].hash
    end
