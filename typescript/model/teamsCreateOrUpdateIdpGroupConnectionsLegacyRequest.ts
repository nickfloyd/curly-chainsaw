...
export class TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequest {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "groups",
            "baseName": "groups",
            "type": "Array<TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequestGroupsInner>"
        },
        {
            "name": "syncedAt",
            "baseName": "synced_at",
    ...
    static getAttributeTypeMap() {
        return TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequest.attributeTypeMap;
    }
}
