...
*/
export class TimelineCommentEvent {
    'event': string;
    'actor': SimpleUser1;
    /**
    ...
    */
    'authorAssociation': TimelineCommentEvent.AuthorAssociationEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "TimelineCommentEvent.AuthorAssociationEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return TimelineCommentEvent.attributeTypeMap;
    }
}

export namespace TimelineCommentEvent {
