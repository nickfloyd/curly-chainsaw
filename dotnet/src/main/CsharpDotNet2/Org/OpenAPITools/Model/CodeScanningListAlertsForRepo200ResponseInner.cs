...
namespace Org.OpenAPITools.Model {
  ...
  /// </summary>
  [DataContract]
  public class CodeScanningListAlertsForRepo200ResponseInner {
    /// <summary>
    ...
    public CodeScanningListAlertsForRepo200ResponseInnerRule Rule { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class CodeScanningListAlertsForRepo200ResponseInner {\n");
