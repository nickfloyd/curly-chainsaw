...
namespace Org.OpenAPITools.Model {
  ...
  public class IssuesRemoveAssigneesRequest {
    ...
    /// </summary>
    /// <value>Usernames of assignees to remove from an issue. _NOTE: Only users with push access can remove assignees from an issue. Assignees are silently ignored otherwise._</value>
