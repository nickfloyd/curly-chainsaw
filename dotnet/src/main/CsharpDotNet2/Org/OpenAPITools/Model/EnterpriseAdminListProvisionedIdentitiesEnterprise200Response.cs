...
namespace Org.OpenAPITools.Model {
  ...
  /// </summary>
  [DataContract]
  public class EnterpriseAdminListProvisionedIdentitiesEnterprise200Response {
    /// <summary>
    ...
    public List<EnterpriseAdminListProvisionedIdentitiesEnterprise200ResponseResourcesInner> Resources { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class EnterpriseAdminListProvisionedIdentitiesEnterprise200Response {\n");
