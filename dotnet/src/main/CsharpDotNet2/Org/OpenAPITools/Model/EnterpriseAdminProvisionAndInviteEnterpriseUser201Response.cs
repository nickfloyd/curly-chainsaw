...
namespace Org.OpenAPITools.Model {
  ...
  /// </summary>
  [DataContract]
  public class EnterpriseAdminProvisionAndInviteEnterpriseUser201Response {
    /// <summary>
    ...
    public List<EnterpriseAdminProvisionAndInviteEnterpriseUser201ResponseEmailsInner> Emails { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class EnterpriseAdminProvisionAndInviteEnterpriseUser201Response {\n");
