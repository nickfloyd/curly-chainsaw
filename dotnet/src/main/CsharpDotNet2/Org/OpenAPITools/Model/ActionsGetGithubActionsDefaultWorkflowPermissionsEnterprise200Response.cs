...
namespace Org.OpenAPITools.Model {
  ...
  /// </summary>
  [DataContract]
  public class ActionsGetGithubActionsDefaultWorkflowPermissionsEnterprise200Response {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class ActionsGetGithubActionsDefaultWorkflowPermissionsEnterprise200Response {\n");
