...
namespace Org.OpenAPITools.Model {
  ...
  /// </summary>
  [DataContract]
  public class ActionsListSelfHostedRunnerGroupsForOrg200ResponseRunnerGroupsInner {
    /// <summary>
    /// Gets or Sets Id
    /// </summary>
    ...
    /// </summary>
    /// <value>Link to the selected repositories resource for this runner group. Not present unless visibility was set to `selected`</value>
    ...
    /// <summary>
    /// Gets or Sets InheritedAllowsPublicRepositories
    /// </summary>
    [DataMember(Name="inherited_allows_public_repositories", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "inherited_allows_public_repositories")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class ActionsListSelfHostedRunnerGroupsForOrg200ResponseRunnerGroupsInner {\n");
      ...
      sb.Append("  InheritedAllowsPublicRepositories: ").Append(InheritedAllowsPublicRepositories).Append("\n");
