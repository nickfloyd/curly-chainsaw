...
namespace Org.OpenAPITools.Model {
  ...
  /// </summary>
  [DataContract]
  public class ServerStatisticsProxyEndpointInnerGithubConnect {
    /// <summary>
    /// Gets or Sets FeaturesEnabled
    /// </summary>
    [DataMember(Name="features_enabled", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "features_enabled")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class ServerStatisticsProxyEndpointInnerGithubConnect {\n");
