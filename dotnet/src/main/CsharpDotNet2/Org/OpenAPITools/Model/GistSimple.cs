...
namespace Org.OpenAPITools.Model {
  ...
  public class GistSimple {
    ...
    [Obsolete]
    public List<GistSimpleForksInner> Forks { get; set; }
    ...
    /// Gets or Sets ForkOf
    /// </summary>
    [DataMember(Name="fork_of", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "fork_of")]
    public Gist ForkOf { get; set; }
    ...
    public Dictionary<string, GistSimpleFilesValue> Files { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  ForkOf: ").Append(ForkOf).Append("\n");
