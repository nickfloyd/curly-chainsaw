...
namespace Org.OpenAPITools.Model {
  ...
  public class PullRequestReviewCommentLinks {
    ...
    public PullRequestReviewCommentLinksSelf Self { get; set; }
    ...
    public PullRequestReviewCommentLinksHtml Html { get; set; }
    ...
    public PullRequestReviewCommentLinksPullRequest PullRequest { get; set; }
