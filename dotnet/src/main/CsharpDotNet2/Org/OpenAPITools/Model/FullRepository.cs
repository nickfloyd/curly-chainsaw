...
namespace Org.OpenAPITools.Model {
  ...
  public class FullRepository {
    ...
    /// <summary>
    /// Gets or Sets AllowUpdateBranch
    /// </summary>
    ...
    /// <summary>
    /// Gets or Sets UseSquashPrTitleAsDefault
    /// </summary>
    ...
    /// </summary>
    /// <value>Whether anonymous git access is allowed.</value>
    [DataMember(Name="anonymous_access_enabled", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "anonymous_access_enabled")]
    ...
    public FullRepositorySecurityAndAnalysis SecurityAndAnalysis { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  AnonymousAccessEnabled: ").Append(AnonymousAccessEnabled).Append("\n");
