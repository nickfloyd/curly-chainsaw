...
namespace Org.OpenAPITools.Model {
  ...
  public class FullTeam {
    ...
    public TeamSimple Parent { get; set; }
    ...
    /// <summary>
    /// Gets or Sets ReposCount
    /// </summary>
    [DataMember(Name="repos_count", EmitDefaultValue=false)]
    ...
    public OrganizationFull Organization { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  ReposCount: ").Append(ReposCount).Append("\n");
